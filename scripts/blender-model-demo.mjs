...
if (mode === 'generate') {
  ...
  const executable = path.join(runtimeRoot, 'runtime/blender.exe');
  ...
  const child = spawn(executable, ['--background', '--factory-startup', '--disable-autoexec', '--python-exit-code', '1', '--python',
