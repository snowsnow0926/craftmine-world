...
if(!archive||!path.isAbsolute(archive))throw Error('Usage: node scripts/templates/publish-approved-worlds.mjs ABS_APPROVED_ARCHIVE');
...
const output=path.join(root,'desktop/godot/shared/promo-templates');
