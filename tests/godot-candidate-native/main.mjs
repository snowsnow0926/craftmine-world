...
app.on('web-contents-created',(_event,contents)=>{
 contents.on('console-message',(_event,details)=>console.log(JSON.stringify({kind:'renderer-console',webContents:contents.id,level:details.level,message:details.message})));
 contents.on('did-fail-load',(_event,code,description,url)=>console.log(JSON.stringify({kind:'load-failed',webContents:contents.id,code,description,url})));
