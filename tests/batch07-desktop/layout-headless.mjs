...
try{
  ...
  check('narrow light appearance preserves full workspace and return action',await page.evaluate(()=>Math.abs(document.querySelector('.work-panel').getBoundingClientRect().width-innerWidth)<1&&document.querySelector('button').textContent.includes('回到创作')));
