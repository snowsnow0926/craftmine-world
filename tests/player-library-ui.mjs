...
if(channel==='worldTemplate.save'){f.receipt={...template,ref:{assetId:args.assetId,version:args.version,contentHash:hash},displayName:args.displayName};if(f.fail)throw Error('LOST_ACK');return f.receipt;}
