...
async function fixture(t){
 ...
 const create=()=>createSourceLibraryService({call,installSource,directory:path.join(directory,'proposals')});
 const context={projectId:'p',sessionId:'s',turnId:'t'};return {ref,archive,blobPath,calls,installs,state,version,create,context,tool:(service,args)=>service.tool(args,context,'world','call-one')};
}
