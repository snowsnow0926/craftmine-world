...
const after=b=>({init:{status:'confirmed',playable:true,candidateId:null,applicationId:'new-application'},application:{id:'new-application',status:'applied',candidateId:'new-candidate'},job:{status:'passed',candidateId:'new-candidate',jobId:'new-job',buildId:'new-build'},formal:{buildId:'new-build'},
