...
func motion_envelope(animal: Node3D, player: AnimationPlayer) -> Dictionary:
 ...
 var report := {"method":"all imported key times, adjacent-key midpoints and uniform 1/240 second samples", "visualPivot":"identity", "rootYaw":"any (radial bound invariant)", "radiusMax":0.0, "yMin":INF, "yMax":-INF, "clips":[], "vertexSamples":0}
