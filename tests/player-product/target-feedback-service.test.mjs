...
async function fixture(t){
 ...
 const files=new Map();for(const name of ['scripts/core/target_dummy.gd','scenes/actors/target_dummy.tscn','scenes/training_range.tscn'])files.set(name,await fs.readFile(path.join(base,name)));
