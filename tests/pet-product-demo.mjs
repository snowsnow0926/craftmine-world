...
try{
 ...
 await until(()=>rpc('godotObserve'),o=>o.worldId===binding.worldId&&o.buildId===report.candidate.buildId,'adopted pet');await readyWorld();report.adoptedIdentity={...binding.formalIdentity};report.source=await pkg('sourceList');await panel('godot.runtimeResume');
