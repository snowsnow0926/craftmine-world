...
const program=ts.createProgram(['main/godot-world-view-host.ts','main/godot-runtime-adapter.ts','main/godot-panel-coordinator.ts','main/godot-candidate-coordinator.ts','main/godot-world-initialization.ts','preload/godot-world.ts'].map(file=>current+'/vendor/pi-desktop/apps/desktop/electron/'+file),options,host);
