...
test('real source store preserves continuation identity after source head advances',{skip:binary?false:'CRAFTMINE_CORE_BIN required'},async t=>{
  ...
  await core.call('godotProject.patch',{context,worldId:'alpha',toolCallId:'advance-query-head',...pin,operations:[{op:'put',path:file.path,expectedHash:file.sha256,text:'extends Node\nfunc new_feature():\n pass\n'}]},30000);
