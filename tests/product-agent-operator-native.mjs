...
const sourceTemplate=option('--starter')??previous?.sourceTemplate??'promo-city';assert(['promo-city','promo-mainline','blank',...(previous?.retainedCopy?['retained']:[])].includes(sourceTemplate),'SUPPORTED_OPERATOR_STARTER_REQUIRED');
