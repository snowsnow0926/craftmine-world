...
creationReferences.push(snapshot({sourcePath:'plugins/craftmine-world/reuse-catalog/asset-index.json',path:'library/asset-index.json'}));
const catalog={version:'1.9.0',requiredInterfacePolicy:{
 ...
 makeSkill({id:'creation-sandbox.authoring',version:'1.9.0',title:'沉浸式造物：先复用真实素材、源码规则与完整进度',
