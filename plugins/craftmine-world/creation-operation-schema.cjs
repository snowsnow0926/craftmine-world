...
const fields={
  ...
  undoOperationId:{type:'string',pattern:'^[a-zA-Z0-9_-]{1,120}$'},targetId:id,count:{type:'integer',minimum:1,maximum:8},timeOfDay:{type:'number',minimum:0,maximum:24},ruleId:id,doorId:id,sequence:{type:'array',items:id,minItems:2,maxItems:16,uniqueItems:true},
};
