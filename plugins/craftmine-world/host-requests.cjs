...
function createHostRequests(core,{verifications,reviews,getSettings,workbench,godotExecutor,assetService,reuseService,portableRestore,packageTurns,targetFeedback,worldTemplates}){
  ...
  const PACKAGE_METHODS=new Set(['check','install','list','read','progress','grant','upgrade','uninstall','restore',
    'exportPackage','importPackage','installSource','sourceList','exportSource','publishSource','publishSourceStatus','cancelPublishSource','sourceProposals','installSourceProposal','usage','backupFull','backupVerify','backupRestoreFull','legacyConvert','explain']);
