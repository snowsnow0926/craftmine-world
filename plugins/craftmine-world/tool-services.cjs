...
const SERVICE_PROVIDERS={
  ...
  sourceLibrary:{kind:'function',owner:'S3',hostMethod:'asset.search+asset.read+asset.bodyPath',provides:'modern source ZIP discovery, player-reviewable proposals and explicit host-authorized full-auto source installation in the active author turn',requiredFor:['godot_source_library']},
