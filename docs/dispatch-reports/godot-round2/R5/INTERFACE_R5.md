...
`BACKUP_ENTRY_TOO_LARGE`、`BACKUP_ARCHIVE_TOO_LARGE`、`BACKUP_DOMAIN_TOO_LARGE`、
`BACKUP_UNSUPPORTED_BLOB`、`BACKUP_DOMAIN_INVALID`、`BACKUP_DOMAIN_MISSING`、
`BACKUP_SCHEMA_MISMATCH`、`BACKUP_COLUMNS_MISMATCH`、`BACKUP_ROW_WIDTH_MISMATCH`、
