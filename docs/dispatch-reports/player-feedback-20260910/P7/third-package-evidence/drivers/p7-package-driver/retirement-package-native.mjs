...
import {materializeBase} from 'file:///D:/cm-fb3-20260910/desktop/godot/shared/materialize.mjs';
const root="D:/cm-fb3-20260910";
...
const {inspectParameterPackage}=await import('file:///D:/cm-fb3-20260910/tests/plan-loop/parameter-client-package.mjs');
const {loadPackageAsar}=await import('file:///D:/cm-fb3-20260910/desktop/package-asar.mjs');
const packageInfo=await inspectParameterPackage({packaged:"D:/cm-fb3-20260910/desktop/build/releases/570fed344ee7-5550aeb3-3715-4dfd-bd1c-58397501ef1c/output/win-unpacked",expectedCommit:"570fed344ee775aa0cc8d4ef7d096bce96e1cc5f",expectedManifestHash:"f802fc7b23b350a0f6c5d4a6ac3cde9272da33ae9f5b26bccfb12efdb040f0c8",asar:loadPackageAsar(path.join(root,'vendor/pi-desktop/apps/desktop'))});
assert.equal(sourceCommit,packageInfo.identity.commit);
assert.equal(spawnSync('git',['status','--porcelain'],{cwd:root,encoding:'utf8',windowsHide:true}).stdout.trim(),'');
const out=fs.mkdtempSync(path.join(root,'test-results/p7-native-'));
const core=packageInfo.core;
const broker=path.resolve("D:/cm-fb3-20260910/desktop/build/releases/570fed344ee7-5550aeb3-3715-4dfd-bd1c-58397501ef1c/output/win-unpacked/resources/godot/broker/godot-host-broker.exe");
const engineRoot="D:/cm-fb3-20260910/desktop/build/releases/570fed344ee7-5550aeb3-3715-4dfd-bd1c-58397501ef1c/output/win-unpacked/resources/godot/engine/4.7.2-stable";
const identity="D:/cm-fb3-20260910/desktop/build/releases/570fed344ee7-5550aeb3-3715-4dfd-bd1c-58397501ef1c/output/win-unpacked/resources/godot/broker/broker-identity.json";
