...
import {inspectParameterPackage,isolatedParameterEnvironment} from 'file:///D:/cm-fb2-20260910/tests/plan-loop/parameter-client-package.mjs';
...
const root='D:/cm-fb2-20260910',original=path.join(root,'test-results/desktop-native-lr-OmsTrR'),profile=path.join(original,'profile');
...
const out=fs.mkdtempSync(path.join(original,'shutdown-minimal-'));
