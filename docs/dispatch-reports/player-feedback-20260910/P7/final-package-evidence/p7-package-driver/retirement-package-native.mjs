...
import {materializeBase} from 'file:///D:/cm-fb2-20260910/desktop/godot/shared/materialize.mjs';
const root="D:/cm-fb2-20260910";
...
const {inspectParameterPackage}=await import('file:///D:/cm-fb2-20260910/tests/plan-loop/parameter-client-package.mjs');
const {loadPackageAsar}=await import('file:///D:/cm-fb2-20260910/desktop/package-asar.mjs');
const packageInfo=await inspectParameterPackage({packaged:"D:/cm-fb2-20260910/desktop/build/releases/beb66d76c00a-04d1dca3-2129-4a62-9cf9-653326e6ef6f/output/win-unpacked",expectedCommit:'beb66d76c00a102c755ec7aeaed59b19cf5c68a9',expectedManifestHash:"44295bd32541ce246465e6a491ef4d32d8f07c66bba2bbb2bc8e0382c5e964fe",asar:loadPackageAsar(path.join(root,'vendor/pi-desktop/apps/desktop'))});
...
const core="D:/cm-fb2-20260910/desktop/build/releases/beb66d76c00a-04d1dca3-2129-4a62-9cf9-653326e6ef6f/output/win-unpacked/resources/bin/craftmine-core.exe";
const broker=path.resolve("D:/cm-fb2-20260910/desktop/build/releases/beb66d76c00a-04d1dca3-2129-4a62-9cf9-653326e6ef6f/output/win-unpacked/resources/godot/broker/godot-host-broker.exe");
const engineRoot="D:/cm-fb2-20260910/desktop/build/releases/beb66d76c00a-04d1dca3-2129-4a62-9cf9-653326e6ef6f/output/win-unpacked/resources/godot/engine/4.7.2-stable";
const identity="D:/cm-fb2-20260910/desktop/build/releases/beb66d76c00a-04d1dca3-2129-4a62-9cf9-653326e6ef6f/output/win-unpacked/resources/godot/broker/broker-identity.json";
