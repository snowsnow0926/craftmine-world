...
const identities={externalDriver:{testCommit:'553d0b6b718517556f12324075c31bd8516de8de',path:fileURLToPath(import.meta.url),sha256:sha(fs.readFileSync(fileURLToPath(import.meta.url))),helperSha256:sha(fs.readFileSync(new URL('./legacy-runtime-ready.mjs',import.meta.url))),difference:'Await the actual automatically reopened runtime; no redundant world.open or unmounted navigation query'},commit,mode:packaged?'packaged':'development',package:info?.identity??null,
