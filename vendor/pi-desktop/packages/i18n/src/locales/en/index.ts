export const en = {
  app: {
    ...
    tagline: "Create a world with your words",
    starting: "Starting craftmine world…",
  ...
  tray: {
    open: "Open craftmine world",
    quit: "Quit craftmine world",
    askTitle: "Keep craftmine world running in the background?",
    askBody:
      "When you close the window, craftmine world can keep running in the system tray. You can change this any time in Settings.",
    closeToTray: "Close to tray",
    confirmQuitTitle: "Quit craftmine world?",
    confirmQuitBody:
  ...
  updates: {
    ...
    dismiss: "Dismiss",
    devDisabled: "Automatic updates are unavailable in this preview.",
  },
  nav: {
    home: "Home",
    newTask: "New task",
  ...
  chat: {
    emptyTitle: "What world will you create today?",
    ...
    placeholder: "What would you like to create in your world?",
    placeholderHome: "Describe an idea, like a meadow of flowers…",
