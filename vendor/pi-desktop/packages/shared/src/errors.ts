...
export const ErrorCodes = {
  ...
  COMPACTION_BUDGET_EXHAUSTED: "COMPACTION_BUDGET_EXHAUSTED",
  TASK_DEADLINE_EXCEEDED: "TASK_DEADLINE_EXCEEDED",
  CRAFTMINE_REQUEST_TOO_LARGE: "CRAFTMINE_REQUEST_TOO_LARGE",
  CRAFTMINE_TASK_STATE_CHANGED: "CRAFTMINE_TASK_STATE_CHANGED",
