...
export type DirectLibraryInspection = {eligible:boolean;configurationRequired?:boolean;reason?:string;warning?:string;displayName?:string;compatibility:'unchecked';positionSupported:boolean};
