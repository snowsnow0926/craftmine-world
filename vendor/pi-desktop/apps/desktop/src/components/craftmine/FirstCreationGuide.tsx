...
const steps = [
  {title: ["打开世界", "Open a world"], body: ["打开世界入口，在“示例世界”创建副本，或在“我的模板”导入 ZIP 后创建。已有世界和示例无需连接 AI 即可游玩。", "Open the world chooser: create a copy in Examples, or import a ZIP in My templates and create a world. Existing worlds and examples can be played without connecting AI."], actions: [["worlds", "选择或新建世界", "Choose or create a world"]]},
