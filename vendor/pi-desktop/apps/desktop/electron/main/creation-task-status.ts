...
export function creationTaskStatus(worldId:string,sessionId:string,job:RecordValue|null,formal:RecordValue){
  ...
  let phase=job.status==="passed"?(formal.buildId===job.buildId?"applied":"ready")
