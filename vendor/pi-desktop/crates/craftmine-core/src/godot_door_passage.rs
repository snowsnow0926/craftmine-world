...
#[derive(Deserialize)]
#[serde(rename_all="camelCase",deny_unknown_fields)]
struct Motion {before:[f64;3],after:[f64;3],started_tick:u64,finished_tick:u64,target_id:Option<String>}
#[derive(Deserialize)]
#[serde(rename_all="camelCase",deny_unknown_fields)]
struct Passage {format:String,door_id:String,instance_id:String,setup:String,bounds_source:String,bounds:Bounds,axis:usize,frames:u16,closed:Motion,opened:Motion}
