...
- **预期**：有模型 id 时答案下方显示模型徽章。有用量后，紧凑上下文
  ...
  段落或内部分隔线。没有缓存读取元数据时省略缓存命中率而不是推算。
...
| M6+ | E2E-121、E2E-122、E2E-123、E2E-142、E2E-148、E2E-150、E2E-151、E2E-168 |
