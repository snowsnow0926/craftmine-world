...
for (const file of ['manifest.json','main.cjs','core-client.cjs','portable-restore-service.cjs','package-turn-lifecycle.cjs','world-tools.cjs','creation-source-service.cjs','creation-timing.cjs','creation-operation-schema.cjs','creation-operations.cjs','creation-sequence-rule.cjs','verification-jobs.cjs','review-jobs.cjs','applications.cjs','host-requests.cjs','context-review.cjs','workbench-service.cjs','godot-executor.cjs','godot-creation-pack.cjs','godot-task-bin-retirement.cjs','godot-routing.cjs','godot-docs.cjs','godot-guidance.cjs','guidance/catalog.json','guidance/equipment-parameters.md','guidance/creation-sandbox.md','guidance/references/double-press-rule.gd','godot-query.cjs','godot-observe.cjs','godot-capability.cjs','godot-history.cjs','godot-jobs.cjs','godot-library.cjs','asset-service.mjs','reuse-service.mjs','tool-services.cjs','godot-build-read-wait.cjs']) {
