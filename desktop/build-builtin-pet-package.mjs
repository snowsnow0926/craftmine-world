...
export function buildBuiltinPetPackage({repository,petRoot=path.join(repository,'desktop/godot/components/pet-companion'),visualRoot=path.join(repository,'desktop/godot/components/canine-visuals')}){
  ...
  const files={
    'scripts/pet_companion.gd':read(petRoot,'scripts/pet_companion.gd'),
